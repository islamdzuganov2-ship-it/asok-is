...
const SEEDS: Seed[] = [
    { system: 'АБС Core', category: 'INFRASTRUCTURE', severity: 'critical', title: 'Отказ контроллера СХД — недоступность ядра АБС', occurred: '2025-11-15T03:00:00Z', mttr: 6, rootCause: 'Выход из строя контроллера СХД; задержка автопереключения на резерв' },
    { system: 'АБС Core', category: 'POWER', severity: 'high', title: 'Просадка питания в основном ЦОД, переход на ИБП', occurred: '2025-11-15T03:00:00Z', mttr: 1.5, rootCause: 'Кратковременный сбой электроснабжения; ИБП отработал с деградацией' },
    { system: 'АБС Core', category: 'NETWORK', severity: 'medium', title: 'Потеря связности с процессинговым узлом', occurred: '2026-03-04T12:00:00Z', mttr: 2, rootCause: 'Обрыв основного канала; маршрутизация ушла на резервный с ростом задержек' },
    { system: 'CRM ОПК', category: 'RELEASE', severity: 'high', title: 'Регрессия расчёта скидок после релиза 4.2', occurred: '2026-02-10T09:00:00Z', mttr: 20, rootCause: 'Некорректная миграция правил ценообразования; откат и хотфикс', release: 'CRM 4.2.0' },
    { system: 'CRM ОПК', category: 'RELEASE', severity: 'medium', title: 'Падение фонового обмена после релиза 4.3', occurred: '2026-04-18T14:00:00Z', mttr: 8, rootCause: 'Изменён контракт интеграции без версии; сломался коннектор', release: 'CRM 4.3.1' },
    { system: 'CRM ОПК', category: 'PERFORMANCE', severity: 'high', title: 'Деградация времени отклика в пиковые часы', occurred: '2026-05-20T11:00:00Z', mttr: null, rootCause: 'Неоптимальные запросы к БД и нехватка пула соединений при росте нагрузки' },
    { system: 'HR Portal', category: 'NETWORK', severity: 'low', title: 'Кратковременная недоступность портала (DNS)', occurred: '2026-01-22T16:00:00Z', mttr: 0.5, rootCause: 'Ошибка в записи DNS при плановой смене провайдера' },
    { system: 'HR Portal', category: 'INFRASTRUCTURE', severity: 'medium', title: 'Переполнение диска сервиса вложений', occurred: '2026-04-02T08:00:00Z', mttr: 3, rootCause: 'Не настроена ротация файлов вложений; диск заполнен' },
    { system: 'Скоринг-ML (СИИ)', category: 'PERFORMANCE', severity: 'high', title: 'Рост задержки инференса модели скоринга', occurred: '2026-05-06T13:00:00Z', mttr: null, rootCause: 'Увеличение признакового пространства без масштабирования узлов' },
];
