...
//
// ФОН ЯЧЕЙКИ теплокарты: под ним тёмный текст BRAND.ink, поэтому пастель держим достаточно
// светлой (≥4.5:1 с #2B3A4B). Шалфей и терракот были на 4.40 и 4.19 — подсветлены (T-57).
export const LEVEL_COLORS: Record<string, string> = {
  'Высокий уровень': '#86B093',     // мягкий шалфей
  'Выше среднего': '#A6C29A',       // светлый шалфей
  'Средний уровень': '#D8BE7E',     // приглушённое золото
  'Ниже среднего': '#D9A47E',       // мягкая глина
  'Низкий уровень': '#D0938A',      // приглушённый терракот
  'Невозможно измерить': '#AAB0B6', // спокойный серый
};

// ПЛАШКА (Tag) с БЕЛЫМ текстом — пастель для этого непригодна (давала 1.81…2.77:1).
// Те же оттенки, углублённые до ≥4.5:1 с белым. Использовать через `solidTagStyle`.
