 ...
 *
 * Переиспользуется на странице «Настройка» (AdminFlagsPage): выбор применяется сразу
 * (dispatch → uiSlice → ConfigProvider + ThemeVarsBridge) и сохраняется в localStorage.
 * Дропдауны с мини-превью палитры темы и образцом шрифта.
 */
