...
import { makeOverviewColumns, resultColumns, type ResultRow } from './newAssessment/assessmentColumns';
...
export const NewAssessmentPage: React.FC = () => {
    ...
    const overviewColumns = makeOverviewColumns(setPeriodId, periodId);
