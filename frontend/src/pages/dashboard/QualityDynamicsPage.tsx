    ...
    <div style={pageContainer}>
      ...
      {isLive ? (
        <Alert
          ...
          description="Динамика строится из истории периодов оценки. Заполните оценки за несколько периодов в разделе «Внесение данных» — графики по характеристикам и подхарактеристикам появятся здесь по реальным данным."
        />
      ) : (
      <>
