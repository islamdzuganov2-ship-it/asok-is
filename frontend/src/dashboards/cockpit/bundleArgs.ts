 ...
 *
 * ВАЖНО: и плитки (ceoTiles/ctoTiles), и `ExecCockpit` (для AI-резюме) обязаны звать
 * `useGetCockpitBundleQuery` с ОДИНАКОВО сериализованными аргументами — RTK Query дедуплицирует
