...
export interface TopRisk {
  code: string; title: string; owner: string | null; system: string | null;
  aleAvg: number; regulatory: boolean;
}

export interface CostDashboard {
  portfolioAle: number; risksCount: number; degradationTotal: number;
  nonconformitiesTotal: number; verified: number;
...
export interface ManagerRow {
  ...
  avgAgeDays: number | null; acceptShare: number; compensatingShare: number;
