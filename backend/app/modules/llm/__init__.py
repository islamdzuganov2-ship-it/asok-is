...
экспорт обучающего корпуса (dataset), фоновые задачи. Здесь же появится конвейер
многоаспектного рассуждения (reasoning.py, Дао Тойота × ISO 25010/38500 — BL-005).
