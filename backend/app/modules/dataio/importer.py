"""
Импортёр Excel — домен dataio (ТЗ v13): каталог метрик, таймлайн качества, матрицы периода.
Сюда же в будущем лягут коннекторы приёма данных из внешних источников (через shared.ports).
"""
...
# каталог метрик сеется ИЗ КОДА — scripts/seed_iso25010 + модель качества модуля quality.
