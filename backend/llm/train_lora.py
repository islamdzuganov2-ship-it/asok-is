...
Вход:  llm_dataset/judgments_sft.jsonl (см. app/scripts/export_llm_dataset.py)
Выход: models/llm/lora-adapter/ (адаптер) → далее merge + convert + quantize в GGUF.

Запуск:  python backend/llm/train_lora.py --base Qwen/Qwen2.5-1.5B-Instruct --data llm_dataset/judgments_sft.jsonl
"""
...
def main() -> None:
    ...
    ap.add_argument("--data", default="llm_dataset/judgments_sft.jsonl")
